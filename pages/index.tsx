...
export default function Home() {
  ...
  const analyzeChart = async () => {
    ...
    try {
      ...
      console.log('Using endpoint:', `${API_BASE_URL}/api/multi-scenario-analysis`);
      ...
      const response = await fetch(`${API_BASE_URL}/api/multi-scenario-analysis`, {
        method: 'POST',
        body: formData,
      });
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="text-xs text-gray-600 font-mono break-all">
                    {API_BASE_URL}/api/multi-scenario-analysis
                  </div>
