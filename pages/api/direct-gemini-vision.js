/**
 * 🚀 DIRECT GEMINI VISION - Using HTTP requests instead of the library
...
export default async function handler(req, res) {
    ...
    try {
        console.log('🚀 Starting Direct Gemini Vision Analysis...');
...
Remember: NO HOLD signals allowed - always choose BUY or SELL based on the strongest indicators.`;
        ...
        console.log('✅ Gemini analysis received via direct HTTP');
        ...
        console.error('❌ Direct Gemini Vision analysis failed:', error);
